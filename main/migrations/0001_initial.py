# Generated by Django 3.0 on 2020-01-15 21:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='group',
            name='super_group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.SuperGroup', verbose_name='Форма обучения'),
        ),
        migrations.AddField(
            model_name='bb',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.SubGroup', verbose_name='Группа'),
        ),
    ]
